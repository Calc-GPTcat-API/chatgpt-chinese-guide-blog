/**
 * 鍏ㄧ珯鍞竴鍩熷悕閰嶇疆婧愩€? * 鏂瑰紡涓€锛氭妸鈥滆繖閲屽～鏂扮珯鍩熷悕鈥濇浛鎹㈡垚姝ｅ紡鍩熷悕锛堝惈 https://锛夈€? * 鏂瑰紡浜岋細鏋勫缓鏃惰缃?SITE_URL=https://your-domain.example銆? */
export const SITE_DOMAIN = process.env.SITE_URL || '杩欓噷濉柊绔欏煙鍚?
...
// 鍗犱綅闃舵浣跨敤 IANA 淇濈暀鍩熷悕锛岄伩鍏嶆棫鍩熷悕鎴栭敊璇煙鍚嶈繘鍏?canonical銆?export const SITE_ORIGIN = SITE_IS_PLACEHOLDER
  ? 'https://example.com'
